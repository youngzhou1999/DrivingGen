...
@register_metric
def fvd2048_100f(opts):
    opts.dataset_kwargs.update(max_size=None, xflip=False)
    fvd = frechet_video_distance.compute_fvd(opts, max_real=2048, num_gen=2048, num_frames=100)
    return dict(fvd2048_100f=fvd)

@register_metric
def fvd2048_9f(opts):
    opts.dataset_kwargs.update(max_size=None, xflip=False)
    fvd = frechet_video_distance.compute_fvd(opts, max_real=2048, num_gen=2048, num_frames=9)
    return dict(fvd2048_9f=fvd)

@register_metric
def fvd_full_9f(opts):
    opts.dataset_kwargs.update(max_size=None, xflip=False)
    fvd = frechet_video_distance.compute_fvd(opts, max_real=1e5, num_gen=1e5, num_frames=9)
    return dict(fvd_full_9f=fvd)
